  ...
  return (
    <form onSubmit={onSubmit} className="bg-sand-soft rounded-[1.75rem] p-7 sm:p-9 shadow-sm">
      <div className="grid gap-5">
        ...
        <button
          type="submit"
          className="btn-shine mt-1 inline-flex items-center justify-center gap-2 bg-sun text-sea-deep font-semibold px-6 py-3.5 rounded-xl hover:bg-sun-light transition-colors"
        >
