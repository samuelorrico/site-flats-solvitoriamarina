  ...
  return (
    <article className="group">
      <div className="relative overflow-hidden rounded-3xl">
        <img src={img} alt={alt} className="w-full h-60 object-cover transition-transform duration-700 group-hover:scale-[1.04]" />
        <span className={`absolute top-3 left-3 text-xs font-semibold px-3 py-1.5 rounded-full ${badgeSea ? 'bg-sun text-sea-deep' : 'bg-sand-soft/95 text-sea'}`}>{badge}</span>
      </div>
    ...
    <>
      ...
      <section id="topo" className="relative">
        <div className="relative h-[88vh] min-h-[560px] w-full overflow-hidden">
          <img src="/images/vista-baia.jpg" alt={dict['hero.tag']} className="hero-img absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img src="/images/piscina-mar.jpg" alt={dict['loc.title']} className="w-full h-[420px] sm:h-[520px] object-cover rounded-[2rem]" />
      ...
      <section id="pier" className="mx-auto max-w-7xl px-5 sm:px-8 py-20 sm:py-28">
        <div className="grid lg:grid-cols-12 gap-6 items-stretch">
          <div className="lg:col-span-7 relative overflow-hidden rounded-[2rem] min-h-[360px]">
            <img src="/images/pier-panoramica.jpg" alt={dict['pier.title']} className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="lg:col-span-5 grid sm:grid-cols-2 lg:grid-cols-1 gap-6">
            <div className="relative overflow-hidden rounded-[2rem] min-h-[180px] group">
              <img src="/images/bondinho.jpg" alt={dict['pier.label']} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="relative overflow-hidden rounded-[2rem] min-h-[180px] group">
              <img src="/images/pier-restaurante.jpg" alt={dict['pier.restaurant']} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
